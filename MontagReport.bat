...
title Montag Store - Sales System (V 90.0 Full Specs)
color 0B
...
:: ============================================================
:: [1] CINEMATIC START (FADE IN LOGO)
:: ============================================================
cls
if exist "%LogoPath%" (
...
:: Start PowerShell and WAIT for it to finish
...
:: ============================================================
:: [3] CINEMATIC EXIT (FADE OUT LOGO)
:: ============================================================
cls
color 00
if exist "%LogoPath%" (
...
# --- 1. GATHER FULL SPECS (RESTORED ENGINE) ---
...
# --- 2. GENERATE HTML UI (CENTERED + FADE IN) ---
$htmlContent = @"
<!DOCTYPE html>
<html lang="en">
<head>
...
<style>
    ...
    .container { 
        ...
        box-shadow: 0 0 40px rgba(143, 0, 255, 0.3); 
        border-radius: 12px; 
    ...
    @keyframes neon {
        from { text-shadow: 0 0 10px #8f00ff, 0 0 20px #8f00ff; }
        to { text-shadow: 0 0 5px #fff, 0 0 10px #ff00ff, 0 0 20px #ff00ff; }
    }
...
# 3. Launch UI via Edge App Mode (Full Screen)
Start-Process "msedge" -ArgumentList "--app=$env:TEMP\MontagSales.html --start-fullscreen" -Wait
