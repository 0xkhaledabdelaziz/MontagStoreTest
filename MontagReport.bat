...
title Montag Store - Sales & Finishing System (V 56.0 Lite)
color 0B
...
:: --- DOWNLOAD ASSETS (BACKGROUND - NO WAIT) ---
if not exist "%IconDir%" mkdir "%IconDir%" >nul 2>&1
if not exist "%IconPath%" start /b curl -L -k -s -o "%IconPath%" "%UrlIcon%" >nul 2>&1
if not exist "%LogoPath%" start /b curl -L -k -s -o "%LogoPath%" "%UrlLogo%" >nul 2>&1
...
echo      =============================================
echo.
echo      [1/3] Applying OEM Branding...
...
:: 5. Logo (Only if ready, otherwise skip to avoid lag)
...
# --- LITE & FAST LOGO LOGIC (200px Width) ---
# Using specific 200px thumbnails to ensure instant loading
...
if ($Man -match "Dell") { 
    $LaptopLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Dell_Logo.svg/200px-Dell_Logo.svg.png"
...
elseif ($Man -match "HP" -or $Man -match "Hewlett") { 
    $LaptopLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/HP_logo_2012.svg/200px-HP_logo_2012.svg.png" 
    $WarrantyLink = "https://support.hp.com/us-en/checkwarranty"
}
elseif ($Man -match "Lenovo") { 
    # FIXED: Using a cleaner, smaller thumb URL for Lenovo
    $LaptopLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Lenovo_logo_2015.svg/200px-Lenovo_logo_2015.svg.png" 
    $WarrantyLink = "https://pcsupport.lenovo.com/us/en/warrantylookup"
}
elseif ($Man -match "Microsoft" -or $Man -match "Surface") {
    $LaptopLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Microsoft_logo_%282012%29.svg/200px-Microsoft_logo_%282012%29.svg.png"
